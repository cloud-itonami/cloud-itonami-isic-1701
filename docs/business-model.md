# Business Model: Manufacture of pulp, paper and paperboard
...
## Classification
- Repository: `cloud-itonami-isic-1701` ([github.com/cloud-itonami/cloud-itonami-isic-1701](https://github.com/cloud-itonami/cloud-itonami-isic-1701))
- ISIC Rev.5: `1701` — Manufacture of pulp, paper and paperboard
- Domain: `:pulp-paper/plant-operations`
- Social impact: :worker-safety :environmental-stewardship :resource-efficiency
- Actor: `:pulp-paper-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :pulp-paper/plant-operations — who wants
...
One managed tenant (:pulp-paper/plant-operations):
...
- Do not bypass the `:pulp-paper-plant-operations-governor` for production decisions.
