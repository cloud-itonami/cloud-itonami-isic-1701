# Operator Quickstart — Manufacture of pulp, paper and paperboard

Shortest path from clone to a verified local dry-run for **ISIC 1701** (`cloud-itonami-isic-1701`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1701.git
cd cloud-itonami-isic-1701
```
...
- Blueprint governor key: `pulp-paper-plant-operations-governor`
- Likely source path: `pulppaper.governor.cljc`
