(ns pulppaper.phase
  "Phase 0->3 staged rollout for the pulp/paper mill plant-operations
  coordination actor.
  ...
  consequence (a digester/paper-machine/effluent-treatment maintenance
  window means production downtime, and the equipment ends up actually
  touched); it is always a human plant supervisor's call.
  `pulppaper.governor`'s `discharge-authorize-blocked-violations`
...
(defn verdict->disposition
  "Map a Pulp & Paper Plant Operations Governor verdict to a base
